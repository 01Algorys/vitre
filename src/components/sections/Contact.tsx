...
const SOCIALS = [
  {
    icon: Globe,
    href: "https://www.instagram.com/cherifouali",
    label: "@cherifouali",
    sub: "561 posts · 157K followers",
  },
  {
    icon: Share2,
    href: "https://www.instagram.com/cherifouali_weddings",
    label: "@cherifouali_weddings",
    sub: "Wedding portfolio",
  },
  {
    icon: Phone,
  ...
  return (
    <section id="contact" className="relative bg-[#0a0a0a] section-padding overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none pointer-events-none">
        <span className="font-display text-[22vw] text-white/[0.013] whitespace-nowrap leading-none">
          Contact
        </span>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Let&apos;s Tell<br />
            <em className="text-gradient-gold not-italic">Your Story</em><br />
            Together.
          </motion.h2>
        </motion.div>
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="text-[#777] text-sm leading-relaxed max-w-sm">
                  ...
                  to discuss your project and begin telling your story.
                </p>
              </motion.div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-8">
                {FIELDS.map(({ field, label, type, placeholder }) => (
                  <div key={field} className="group">
                    <label className="block text-[10px] tracking-[0.35em] uppercase text-[#555] mb-2.5">
                      {label}
                    </label>
                    <input
                      type={type}
          ...
          >
            <motion.div variants={fadeUp}>
              ...
              <a
                ...
                className="font-display text-2xl text-white hover:text-[#d4af37] transition-colors duration-300"
                data-cursor-hover
              >
            ...
            <motion.div variants={fadeUp}>
              ...
              <p className="text-[#ccc] text-lg font-light">📍 Tunisia &nbsp;·&nbsp; 📍 Paris</p>
              <p className="text-[#555] text-sm mt-1.5">Available for travel worldwide</p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="glass rounded-sm p-6 border border-white/5">
              ...
              <p className="text-[#555] text-xs leading-relaxed">
                Accepting wedding &amp; portrait bookings for 2025–2026.
                Response within 24 hours via email or WhatsApp.
              </p>
            </motion.div>
          </motion.div>
        </div>
